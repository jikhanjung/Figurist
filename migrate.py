...
ret = router.create(auto=[FgCollection,FgReference,FgCollectionReference,FgTaxon,FgFigure,FgTaxonReference,FgTaxonFigure,FgAttachment], name=migration_name)
print("ret: ", ret)
