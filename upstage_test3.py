...
class UpstageDocParseApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.document_label = DocumentLabel()
        self.document_label.text_selected.connect(self.showSelectedText)
        print("Connected text_selected signal")  # Debug print
        ...
        for batch in batch_results:
            ...
            if 'elements' in result:
                ...
                for element in result['elements']:
                    # Get page number from element's metadata or coordinates
                    # Assuming the API provides page information in the element
                    if 'page' in element:
    ...
    def loadPdfPage(self, page_number):
        ...
        try:
            ...
            self.document_label.current_page = page_number  # Set current page
            
            # If we have processed results for this page, show them
    ...
    def goToPage(self, page_number):
        if self.pdf_document and 1 <= page_number <= self.total_pages:
            self.current_page = page_number
